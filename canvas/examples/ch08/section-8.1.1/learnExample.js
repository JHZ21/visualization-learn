...
let GRAVITY_FORCE = 9.81,  // 9.81 m/s / s
...
PUSH_ANIMATION_DURATION = 800,
  pushAnimationTimer = new Animation(PUSH_ANIMATION_DURATION),
  fallingAnimationTimer = new Animation(),
  ...
  fallOnLedge = {
    ...
    ball = new Sprite('ball', {
      paint: function (sprite, context) {
        ...
        context.shadowColor = 'rgba(100, 100, 195, 0.8)'
...
function paintThrusters() {
  ...
  if (pushAnimationTimer.isRunning()) {
    thrustersContext.fillStyle = 'rgba(255,255,0)'
  } else {
